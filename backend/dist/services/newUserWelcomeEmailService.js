...
function buildWelcomeEmailContent({ userName, temporaryPassword, loginUrl, systemName, }) {
...
exports.newUserWelcomeEmailService = {
    async sendWelcomeEmail({ to, userName, temporaryPassword }) {
