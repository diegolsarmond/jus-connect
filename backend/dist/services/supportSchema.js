...
exports.ensureSupportSchema = ensureSupportSchema;
...
async function resolveSchemaPath() {
    ...
    const candidatePaths = [
        node_path_1.default.resolve(__dirname, '..', 'sql', 'support.sql'),
        node_path_1.default.resolve(__dirname, '../..', 'sql', 'support.sql'),
        node_path_1.default.resolve(process.cwd(), 'sql', 'support.sql'),
        node_path_1.default.resolve(process.cwd(), 'backend', 'sql', 'support.sql'),
    ];
    ...
    throw new Error(`Support schema file not found. Checked: ${candidatePaths
...
async function ensureSupportSchema(client = db_1.default) {
