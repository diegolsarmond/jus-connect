...
protectedApiRouter.use(areaAtuacaoRoutes_1.default);
protectedApiRouter.use(tipoEventoRoutes_1.default);
protectedApiRouter.use(tipoProcessoRoutes_1.default);
protectedApiRouter.use(tipoDocumentoRoutes_1.default);
protectedApiRouter.use(escritorioRoutes_1.default);
protectedApiRouter.use(perfilRoutes_1.default);
protectedApiRouter.use(planoRoutes_1.default);
protectedApiRouter.use(situacaoProcessoRoutes_1.default);
protectedApiRouter.use(situacaoClienteRoutes_1.default);
protectedApiRouter.use(situacaoPropostaRoutes_1.default);
protectedApiRouter.use(etiquetaRoutes_1.default);
protectedApiRouter.use(empresaRoutes_1.default);
protectedApiRouter.use(usuarioRoutes_1.default);
protectedApiRouter.use(clienteRoutes_1.default);
protectedApiRouter.use(agendaRoutes_1.default);
protectedApiRouter.use(templateRoutes_1.default);
protectedApiRouter.use(tagRoutes_1.default);
protectedApiRouter.use(documentRoutes_1.default);
protectedApiRouter.use(financialRoutes_1.default);
protectedApiRouter.use(processoRoutes_1.default);
protectedApiRouter.use(fluxoTrabalhoRoutes_1.default);
protectedApiRouter.use(uploadRoutes_1.default);
protectedApiRouter.use(oportunidadeRoutes_1.default);
protectedApiRouter.use(tarefaRoutes_1.default);
protectedApiRouter.use(tarefaResponsavelRoutes_1.default);
protectedApiRouter.use(clienteDocumentoRoutes_1.default);
protectedApiRouter.use(supportRoutes_1.default);
protectedApiRouter.use(notificationRoutes_1.default);
protectedApiRouter.use(integrationApiKeyRoutes_1.default);
protectedApiRouter.use(chatRoutes_1.default);
