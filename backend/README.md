...
Por padrão o backend libera requisições vindas de `localhost` e do domínio `https://quantumtecnologia.com.br`. Caso precise habilitar outros hosts, defina a variável de ambiente `CORS_ALLOWED_ORIGINS` com uma lista de URLs separadas por vírgula:
