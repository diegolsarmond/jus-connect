            ...
            <div className="max-w-4xl">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://wa.me/553193054200?text=Olá! Quero transformar minha operação com o Quantum Jud.",
                      "_blank",
                    )
                  }
                >
                ...
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="rounded-xl border border-quantum-light/60 bg-white/80 p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Agenda estratégica gratuita para mapear oportunidades com especialistas Quantum Jud.
                    </p>
                    <Button
                      variant="quantum"
                      size="lg"
